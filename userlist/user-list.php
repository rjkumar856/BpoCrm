							...
							<table class="table jsgrid table-striped table-bordered dataTable table-responsive" id="table-2">
								<thead>
									<tr>
										...
										<th>Address</th>
										<th>Course Type</th>
										<th>Test Permission<br/><span><small>Add access</small></span></th>
										<th>STATUS<br/><span><small>Click to activate/deactivate</small></span></th>
									</tr>
								</thead>
								<tbody>
    									...
    									<td><?php echo $stmt1->full_name;?></td>
    										...
    										<td><a class="btn btn-primary" href="change-prelims-test-access?id=<?php echo $stmt1->id;?>" >Add</a></td>
